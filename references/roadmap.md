...
| A | **M-MP Phase 3** Cross-prompt M5a + M5b (Qwen + Idefics2 × 3 prompts) — *causal* test | ▶ next up | 3 | G1 — causal evidence |
| — | **M5b post-projection SAE** (Qwen first, then cross-model if interesting) | planned ahead of Phase 3 per user 2026-04-28 | between weeks 2–3 | mechanism resolution (encoder pre/post-projector) |
