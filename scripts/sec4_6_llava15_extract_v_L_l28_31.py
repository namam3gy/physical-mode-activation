"""Extract v_L at L28/30/31 from the LLaVA-1.5 deeper-layer capture.

Mirrors `sec4_6_idefics2_extract_v_L_l26_31.py` but targets the new
`cross_model_llava_capture_l28_31_*` capture run, whose LM hidden
states cover L28/30/31 (≥ 87 % of LLaMA-2-7B's 32 layers).
Required for §4.6 LLaVA-1.5 deeper-layer sweep.
"""
...
LAYERS = (28, 30, 31)
RUN_PATTERN = "cross_model_llava_capture_l28_31_*"
