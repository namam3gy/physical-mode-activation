...
*그림*: 같은 M8a stim 에서 5 캡처된 VLM 의 마지막 token attention 의 시각
token 비율 layer 별. Dashed 선 = uniform baseline (n_visual / seq_len,
79–98%). 5 모델 모두 baseline 보다 훨씬 적게 attend, mid-layer (15 또는 20)
에서 정점.
