...
5×4 시각 그리드 (`docs/figures/m8a_shape_grid.png`)에서 각 셀이 시각적으로
구별되며 추상화 진행이 보존됨을 확인했다.
...
`docs/figures/m8a_pmr_ramp.png` 참조.
...
`docs/figures/m8a_pmr_by_role.png` 참조.
...
`docs/figures/m8a_paired_delta.png` 참조.
