...
- `docs/figures/encoder_chain_5model.png` — 논문 헤드라인 figure (4model 대체)
- `docs/figures/encoder_chain_4model.png` — frozen 4-모델 스냅샷 (r3/r4/r5 doc 용)
- `docs/figures/encoder_swap_llava_next_probe.png`
- `docs/figures/m9_summary.png`, `m9_table1_heatmap.png` (§4.2 PREFIXES 업데이트로 5-모델 M8c 행 추가)
...
- **§4.10** Attention 시각화 UI — 논문 부록 figure (이 세션 시작 설정;
  아직 미구현).
