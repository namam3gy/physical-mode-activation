...
const OUT = path.join(__dirname, "physical_mode_storyline_ko.pptx");
...
// ========================================================================
{
  ...
  s.addText("논문 발표용 · 2026년 4월 (M0–M9 + §4 series + Pillar A 완료)", {
...
// ========================================================================
{
  ...
  addFooter(s);
  addPageNumber(s, 23, 26);
}

// ========================================================================
// SLIDE 24 — Limitations & Future
// ========================================================================
{
  const s = addContentSlide();
